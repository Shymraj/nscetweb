...
import { getSeoForPath, updateMetaDescription } from "./seo/seoConfig";
...
const AppContent = () => {
  ...
  useEffect(() => {
    ...
    if (location.pathname.startsWith("/departments/") && location.pathname.includes("/faculty/")) {
      // Faculty portfolio pages handle their own title and meta description dynamically
      return;
    }
