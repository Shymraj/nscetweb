...
export const cseFacultyData = [
  {
    ...
    desig: "Assistant Professor & Head [I/C]",
    qual: "M.E (CSE), Ph.D",
    email: "hodcse@nscet.org",
    image: imgMathalaiRaj,
    spec: "Artificial Intelligence & Cloud Computing",
    objectPosition: "center 10%",
    linkedin: "https://www.linkedin.com/in/mathalairaj",
    about: "Dr. J. Mathalai Raj is an esteemed researcher and academician specializing in Artificial Intelligence and Cloud Computing architectures. With a visionary approach to engineering education, he leads the CSE department towards excellence by bridging the gap between cutting-edge industry practices and academic rigor.",
    publications: [
