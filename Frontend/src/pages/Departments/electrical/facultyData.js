...
export const electricalFacultyData = [
    ...
    {id: "mrs-n-abirami", slug: "mrs-n-abirami",  name: "Mrs. N. Abirami", desig: "Assistant Professor", qual: "M.E., (Ph.D.)", email: "abiramin@nscet.org", image: imgAbirami, spec: "Electrical Machines & Special Drives", objectPosition: "center 10%" ,
    linkedin: "https://www.linkedin.com/in/dummy-nscet",
    about: "This is a placeholder professional summary. The actual academic and professional details will be updated shortly.",
    publications: [
      "Dummy Publication Title 1 — Journal of Engineering, 2024",
