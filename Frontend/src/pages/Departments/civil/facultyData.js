...
export const civilFacultyData = [
    ...
    highlights: [
      {
        ...
        description: "Leading the Department of Civil Engineering with focus on structural safety, concrete innovation, and industry consultancy.",
      },
      {
        title: "Specialization & Research",
        description: "M.E., M.I.S.T.E., (Ph.D) in Structural Engineering and Concrete Technology.",
      },
      {
  ...
  },
  {
    ...
    highlights: [
      {
        title: "Academic Qualification",
        description: "M.E. specializing in Transportation Engineering and Advanced Land Surveying.",
      },
      {
        title: "Field Training Lead",
        description: "Mentoring students in Total Station, DGPS, and Highway Design.",
      },
      {
        title: "Contact",
  ...
  },
  {
    ...
    highlights: [
      {
        title: "Academic Qualification",
        description: "M.E. specializing in Structural Analysis and Reinforced Concrete Structures.",
      },
      {
        title: "Teaching Focus",
        description: "Design of RC elements, structural dynamics, and CAD drawing.",
      },
      {
        title: "Contact",
  ...
  },
  {
    ...
    highlights: [
      {
        title: "Academic Qualification",
        description: "M.Tech specializing in Water Resources Engineering and Fluid Mechanics.",
      },
      {
        title: "Research Focus",
        description: "Hydraulic structures, watershed management, and fluid machinery.",
      },
      {
        title: "Contact",
  ...
  },
  {
    ...
    highlights: [
      {
        title: "Academic Qualification",
        description: "M.E. specializing in Structural Dynamics and Computer-Aided Design.",
      },
      {
        title: "Software & Prototyping",
        description: "STAAD.Pro, AutoCAD, and structural model testing.",
      },
      {
        title: "Contact",
...
export function getFacultyById(id) {
  if (!id) return civilFacultyData[0];
  const cleanedId = id.toLowerCase().trim();
  return civilFacultyData.find(f => f.id === cleanedId || f.slug === cleanedId) || civilFacultyData[0];
}
