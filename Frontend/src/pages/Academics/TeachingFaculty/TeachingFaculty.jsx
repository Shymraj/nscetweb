...
const TeachingFaculty = () => {
  ...
  const facultyData = [
    ...
    { id: 19, name: "Ms. S. Abirami Kayathiri", qualifications: ["M.E."], department: "B.E. - Computer Science Engineering", position: "Assistant Professor", email: "abiramikayathiri@nscet.org", photo: "/CSE/abirami.jpeg", isHOD: false },
    ...
    { id: 21, name: "Mrs. Anusuya V", qualifications: ["B.E - CSE, M.E - CSE"], department: "B.E. - Computer Science Engineering", position: "Assistant Professor", email: "anusuya@nscet.org", photo: "/CSE/ANUSUYA VAIRAMUTHU.jpg", isHOD: false },
    ...
    { id: 91, name: "Ms. P. AadhityaPraveen S", qualifications: ["M.E."], department: "B.E. - Civil Engineering", position: "Assistant Professor", email: "aadhitya@nscet.org", photo: "/CIVIL/aadhithya.jpg", isHOD: false },
    ...
    { id: 32, name: "Mr. R. Nagaraja", qualifications: ["B.E - Mechanical, M.E - Engineering Design"], department: "B.E. - Mechanical Engineering", position: "Assistant Professor", email: "nagaraja@nscet.org", photo: "/MECH/nagaraja.jpg", isHOD: false },
    { id: 33, name: "Mr. J. Chakaravarthy Samy Durai", qualifications: ["B.E - Mechanical, M.E - Manufacturing"], department: "B.E. - Mechanical Engineering", position: "Assistant Professor", email: "chakravarthysamydurai@nscet.org", photo: "/MECH/chakravarthysamydurai.jpg", isHOD: false },
    { id: 34, name: "Mr. S. Harikishore", qualifications: ["B.E - Mechanical, M.E - Manufacturing"], department: "B.E. - Mechanical Engineering", position: "Assistant Professor", email: "harikishore@nscet.org", photo: "/MECH/harikishore.jpg", isHOD: false },
    { id: 35, name: "Mr. V. Sivaganesan", qualifications: ["B.E - Mechanical, M.E - Engineering Design"], department: "B.E. - Mechanical Engineering", position: "Assistant Professor / Deputy COE", email: "sivaganesan@nscet.org", photo: "/MECH/sivaganesan.jpg", isHOD: false },
    ...
    { id: 42, name: "Dr. N. Mathavan", qualifications: ["B.Tech - ECE, M.E - Computer & Communication, Ph.D - Information & Communication"], department: "B.E. - Electronics and Communication Engineering", position: "Assistant Professor", email: "staff@nscet.org", photo: "/ECE/Mathavan.jpg", isHOD: false },
    { id: 43, name: "Mr. M. Idhayachandran", qualifications: ["B.E - ECE, M.E - VLSI Design"], department: "B.E. - Electronics and Communication Engineering", position: "Assistant Professor", email: "staff@nscet.org", photo: "/ECE/idhayachandran.jpg", isHOD: false },
    { id: 44, name: "Mr. S. Prathap", qualifications: ["B.E - ECE, M.E - Communication Systems"], department: "B.E. - Electronics and Communication Engineering", position: "Assistant Professor", email: "prathaps@nscet.org", photo: "/ECE/prathap.jpg", isHOD: false },
    { id: 45, name: "Mr. R. Pradeep Kumar", qualifications: ["B.E - ECE, M.E - Applied Electronics"], department: "B.E. - Electronics and Communication Engineering", position: "Assistant Professor", email: "pradeepkumar@nscet.org", photo: "/ECE/pradeepkumar.jpg", isHOD: false },
    { id: 46, name: "Mrs. T. Tamilselvi", qualifications: ["B.E - ECE, M.Tech - VLSI Design"], department: "B.E. - Electronics and Communication Engineering", position: "Assistant Professor", email: "tamilselvi@nscet.org ", photo: "/ECE/tamilselvi.jpg", isHOD: false },
    ...
    { id: 76, name: "Mr. R. Raja Karthick", qualifications: ["B.E - ICE, M.E - Applied Electronics"], department: "B.E. - Electrical and Electronics Engineering", position: "Assistant Professor", email: "rajakarthick@nscet.org", photo: "/EEE/raja_karthick.jpg", isHOD: false },
    { id: 77, name: "Mrs. A. Nishetha Jeflin Nixon", qualifications: ["B.E - EEE, M.E - Power Electronics and Drives"], department: "B.E. - Electrical and Electronics Engineering", position: "Assistant Professor", email: " nishethajeflinnixon@nscet.org", photo: "/EEE/Nishetha_jeflin_nixon.jpg", isHOD: false },
    { id: 78, name: "Mrs. M. Vijayalakshmi", qualifications: ["B.E - EEE, M.E - Power Systems"], department: "B.E. - Electrical and Electronics Engineering", position: "Assistant Professor", email: " vijayalakshmi@nscet.org", photo: "/EEE/Vijayalakshmi.jpg", isHOD: false },
    { id: 79, name: "Mr. C. Shiva", qualifications: ["B.E - EEE, M.E - Power Electronics and Drives"], department: "B.E. - Electrical and Electronics Engineering", position: "Assistant Professor", email: "shiva@nscet.org", photo: "/EEE/shiva.jpg", isHOD: false },
    { id: 80, name: "Mrs. N. Abirami", qualifications: ["B.E - EEE, M.E - VLSI Design"], department: "B.E. - Electrical and Electronics Engineering", position: "Assistant Professor", email: "abiramin@nscet.org", photo: "/EEE/Abirami.jpg", isHOD: false },
    ...
    { id: 53, name: "Dr. C. Mathalai Sundaram", qualifications: ["B.E - Mechanical, M.E - Manufacturing, Ph.D - Mechanical"], department: "M.E. - Manufacturing Engineering", position: "Principal", email: "principal@nscet.org", photo: "/ME MANUFACTURING/principle.png", isHOD: false },
    { id: 54, name: "Dr. A. Vennimalai Rajan", qualifications: ["B.E - Mechanical, M.E - Manufacturing, Ph.D - Mechanical"], department: "M.E. - Manufacturing Engineering", position: "Assistant Professor", email: "anandan@nscet.org", photo: "/MECH/Vennimalairajan.jpg", isHOD: false },

    // --- M.E. - Embedded Systems and Technology (Total: 2) ---
    { id: 55, name: "Dr. R. Athilingam", qualifications: ["B.E - EIE, M.E - Applied Electronics, Ph.D - Information & Communication"], department: "M.E. - Embedded Systems and Technology", position: "Associate Professor", email: "athilingam@nscet.org", photo: "/EEE/athilingam.jpg", isHOD: false },
    { id: 56, name: "Mrs. S. Kalaivani", qualifications: ["B.E - ECE, M.E - VLSI & Embedded System"], department: "M.E. - Embedded Systems and Technology", position: "Assistant Professor", email: "kalaivani@nscet.org", photo: "/ME EMBODDED SYSTEMS/kalaivani.jpg", isHOD: false },

    // --- Science & Humanities (Total: 31 Unique) ---
    { id: 59, name: "Dr. A. Vembathurajesh", qualifications: ["B.E - Mechanical, M.E - Thermal, Ph.D - Mechanical"], department: "Science & Humanities", position: "Assistant Professor & Head [I/C] / S&H", email: "vembathurajesh@nscet.org", photo: "/S&H/vembathurajesh.png", isHOD: true },
    ...
    { id: 69, name: "Ms. Sangeetha V", qualifications: ["B.A., M.A., English (NET)"], department: "Science & Humanities", position: "Assistant Professor", email: "vijayansangeetha281985@gmail.com", photo: "/S&H/Sangeetha.jpeg", isHOD: false },
    ...
    { id: 74, name: "Dr. Srinithi S", qualifications: ["B.Sc., M.Sc., Ph.D - Chemistry"], department: "Science & Humanities", position: "Assistant Professor", email: "staff@nscet.org", photo: "/S&H/Srinithi.jpeg", isHOD: false },
    ...
    { id: 77, name: "Mr. Ram Kumar K", qualifications: ["B.E - EEE, M.B.A - Financial Management"], department: "Science & Humanities", position: "Assistant Professor", email: "ramkumar@nscet.org", photo: "/S&H/ramkumar.jpeg", isHOD: false },
    ...
    { id: 80, name: "Dr. Premkumar S", qualifications: ["B.E - Civil, M.E - Hydrology & Water Resources, Ph.D – Civil Engineering"], department: "Science & Humanities", position: "Assistant Professor", email: "vignesan@nscet.org", photo: "/S&H/Premkumar.jpg", isHOD: false },
    { id: 81, name: "Ms. Nandhini M", qualifications: ["B.E - CSE, M.E - CSE"], department: "Science & Humanities", position: "Assistant Professor", email: "benandhu10@gmail.com", photo: "/S&H/Nandini.jpeg", isHOD: false },
    ...
    { id: 89, name: "Mrs. S. Rajeshshree", qualifications: ["B.E - ECE, M.E - Applied Electronics"], department: "Science & Humanities", position: "Assistant Professor", email: "rajeshshree@nscet.org", photo: "/ECE/Rajeshshree.jpeg", isHOD: false }
  ];
